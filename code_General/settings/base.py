...
ROOT_URLCONF = 'code_General.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATE_DIR, DOC_DIR, ADDITIONAL_TEMPLATE_DIR_SEMPER_KI],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Callers
WSGI_APPLICATION = 'code_General.wsgi.application'
ASGI_APPLICATION = "code_General.asgi.application"
