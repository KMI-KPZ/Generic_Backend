...
newPaths = { 
    ...
    "createAddress": ("public/createAddress/", profiles.createAddress),
    "updateAddress": ("public/updateAddress/", profiles.updateAddress),
    "deleteAddress": ("public/deleteAddress/<str:addressID>/", profiles.deleteAddress),
