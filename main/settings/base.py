...
class BackendConfigHelper(ConfigHelper):
    ...
    env_vars_external = {
        ...
        'AUTH0_DOMAIN': {'var': 'AUTH0_DOMAIN',
                         'hint': 'Auth0 domain as endpoint for authentication services', 'default': None,
                         'required': True},
        ...
        'EMAIL_ADDR_SUPPORT' : {'var': 'EMAIL_ADDR_SUPPORT', 'hint': 'Email address for support, i.e. for contact form', 'default': 'bla@bla.com', 'required': False},
    }
    ...
    env_vars_internal = {
        ...
        'POSTGRES_PORT': {'var': 'POSTGRES_PORT', 'hint': 'Postgres port for database', 'default': '5432',
                          'required': True},
        'POSTGRES_NAME': {'var': 'POSTGRES_NAME', 'hint': 'Postgres database for database', 'default': 'generic_db',
                          'required': True},
        ...
        'ALLOWED_HOSTS': {'var': 'ALLOWED_HOSTS', 'hint': 'Allowed hosts for the backend API calls, comma separated',
                          'type': 'list',
                          'default': '127.0.0.1,localhost', 'required': False},
